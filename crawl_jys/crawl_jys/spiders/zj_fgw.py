...
class ZjFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'zj_fgw'
    ...
    def parse(self, response):
        ...
        items = super(ZjFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(ZjFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
