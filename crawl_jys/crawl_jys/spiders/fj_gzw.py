...
class FjGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'fj_gzw'
    ...
    def parse(self, response):
        ...
        items = super(FjGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(FjGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        self.get_element_by_xpath("//ul[@id='BMDWLIST']//a[@siteid='ff8080816e59baf3016e5e7264fe4056']").click()
