...
class GzFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'gz_fgw'
    start_urls = ['http://fgw.guizhou.gov.cn']
    ...
    def parse(self, response):
        ...
        search_xpath = "//div[@class='inputText SearchBox_2021']/a[@class='but f_r']"
        items = super(GzFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GzFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
