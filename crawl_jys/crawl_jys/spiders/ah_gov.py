...
class AhGovSpider(scrapy.Spider, BaseCrawl):
    name = 'ah_gov'
    ...
    def parse(self, response):
        ...
        items = super(AhGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        next_xp = "//a[@title='下一页']"
        super(AhGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
