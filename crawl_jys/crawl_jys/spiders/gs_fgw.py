...
class GsFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'gs_fgw'
    start_urls = ['http://fzgg.gansu.gov.cn']
    timeout = 3
    # custom_settings = {
    #     'HEADLESS': False,
    #     'IMAGELESS': True
    ...
    def parse(self, response):
        ...
        search_xpath = '//*[@id="btns"]'
        items = super(GsFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GsFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '甘肃发改委'  # 需要修改为当前的网站名，如：广东发改委
