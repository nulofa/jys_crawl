...
class NxGovSpider(scrapy.Spider, BaseCrawl):
    name = 'nx_gov'
    ...
    def parse(self, response):
        ...
        search_xpath = '//*[@id="btn"]'
        items = super(NxGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(NxGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '宁夏政府网'  #需要修改为当前的网站名，如：广东发改委
