...
class JsGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'js_gzw'
    start_urls = ['http://jsgzw.jiangsu.gov.cn']
    ...
    def parse(self, response):
        input_xpath = '//*[@id="txt"]'
        search_xpath = '//*[@id="btn"]'
        items = super(JsGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(JsGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '江苏国资委'  # 需要修改为当前的网站名，如：广东发改委
