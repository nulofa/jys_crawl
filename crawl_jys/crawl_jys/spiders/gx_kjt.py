...
class GxKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'gx_kjt'
    start_urls = ['http://kjt.gxzf.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(GxKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GxKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
