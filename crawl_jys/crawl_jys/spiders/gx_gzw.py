...
class GxGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'gx_gzw'
    start_urls = ['http://gzw.gxzf.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(GxGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GxGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
