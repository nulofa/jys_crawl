...
class TjGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'tj_gzw'
    start_urls = ['http://sasac.tj.gov.cn']
    # custom_settings = {
    #     'HEADLESS': False,
    #     'IMAGELESS': True
    # }
    ...
    def parse(self, response):
        input_xpath = '//*[@id="inputkeyword"]'
        search_xpath = '//*[@id="search"]'
        items = super(TjGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(TjGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '天津国资委'  #需要修改为当前的网站名，如：广东发改委
