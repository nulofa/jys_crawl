...
class HenanFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'henan_fgw'
    ...
    def parse(self, response):
        ...
        items = super(HenanFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HenanFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        try:
            ...
            self.get_element_by_xpath("//div[@class='select-items'][1]").click() # fgw
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '河南发改委'  # 需要修改为当前的网站名，如：广东发改委
