...
class JsFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'js_fgw'
    start_urls = ['http://fzggw.jiangsu.gov.cn']
    ...
    def parse(self, response):
        input_xpath = '//*[@id="q"]'
        search_xpath = "//input[@class='searchBtn']"
        items = super(JsFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(JsFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '江苏发改委'  #需要修改为当前的网站名，如：广东发改委
