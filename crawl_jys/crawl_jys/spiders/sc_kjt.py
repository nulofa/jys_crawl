...
class ScKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'sc_kjt'
    start_urls = ['http://kjt.sc.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(ScKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(ScKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
