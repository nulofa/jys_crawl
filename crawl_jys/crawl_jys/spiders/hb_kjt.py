...
class HbKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'hb_kjt'
    ...
    def parse(self, response):
        ...
        items = super(HbKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HbKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        try:
            ...
            self.get_element_by_xpath("//div[@class='siteId_children department_site']//li[3]").click()  # 选择部门
            ...
            self.get_element_by_xpath("//div[@class='siteCheckDiv']").click()
            self.waitor("//div[@class='siteId_children department_site']")
            self.get_element_by_xpath("//div[@class='siteId_children department_site']//li[3]").click()
            self.get_element_by_xpath("//div[@class='siteIdCheckList']//div[@class='btns fr']/button[1]").click()
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '湖北科技厅'  # 需要修改为当前的网站名，如：广东发改委
