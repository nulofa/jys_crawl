...
class HnGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'hn_gzw'
    start_urls = ['http://gzw.hainan.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(HnGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HnGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
