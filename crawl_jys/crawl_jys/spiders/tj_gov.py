...
class TjGovSpider(scrapy.Spider, BaseCrawl):
    name = 'tj_gov'
    start_urls = ['http://www.tj.gov.cn']
    ...
    def parse(self, response):
        ...
        search_xpath = "//input[@onclick='jumpToSearch()']"
        items = super(TjGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        date_xp = ".//span[@class='date ng-binding ng-scope']"
        content_xp = ".//div[@class='pic_list_con ng-binding']"
        title_xp = ".//div[@class='tit clearfix']/a"
        url_xp = ".//div[@class='tit clearfix']/a"
        next_xp = "//div[@class='list_page clearfix ng-scope']/a[last()-2]/i[1]"
        super(TjGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '天津政府网'  #需要修改为当前的网站名，如：广东发改委
