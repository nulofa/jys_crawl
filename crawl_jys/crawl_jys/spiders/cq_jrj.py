...
class CqJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'cq_jrj'
    ...
    def parse(self, response):
        ...
        items = super(CqJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(CqJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        self.browser.find_element_by_xpath('//*[@id="szfbm"]//a[@name="500000144"]').click()
