...
class ZjKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'zj_kjt'
    start_urls = ['http://kjt.zj.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(ZjKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(ZjKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
