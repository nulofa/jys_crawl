...
class HebeiKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'hebei_kjt'
    start_urls = ['https://kjt.hebei.gov.cn']
    # custom_settings = {
    #     'HEADLESS': False,
    #     'IMAGELESS': True
    # }
    ...
    def parse(self, response):
        input_xpath = '//*[@id="q"]'
        search_xpath = '//*[@id="sybtn"]'
        items = super(HebeiKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        date_xp = ".//p[@class='dates']/span"
        content_xp = ".//p[@class='txtCon hasImg']"
        title_xp = "./h3/a"
        url_xp = "./h3/a"
        next_xp = '//*[@id="default-result-paging"]/li[last()]/a'
        super(HebeiKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '河北科技厅'  # 需要修改为当前的网站名，如：广东发改委
