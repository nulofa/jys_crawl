...
class HbGovSpider(scrapy.Spider, BaseCrawl):
    name = 'hb_gov'
    ...
    def parse(self, response):
        ...
        items = super(HbGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HbGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '湖北政府网'  #需要修改为当前的网站名，如：广东发改委
