...
class HunanKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'hunan_kjt'
    ...
    def parse(self, response):
        ...
        items = super(HunanKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HunanKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        try:
            ...
            self.get_element_by_xpath("//div[@class='orgchange-con']//span[@data-id='4']").click()  # kjt
            ...
            self.get_element_by_xpath("//div[@class='change-org fl']").click()
            self.waitor("//div[@class='orgchange-con']")
            self.get_element_by_xpath("//div[@class='orgchange-con']//span[@data-id='4']").click()
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '湖南科技厅'  # 需要修改为当前的网站名，如：广东发改委
