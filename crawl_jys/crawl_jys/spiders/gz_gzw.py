...
class GzGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'gz_gzw'
    start_urls = ['http://gzw.guizhou.gov.cn']
    ...
    def parse(self, response):
        ...
        search_xpath = '//*[@id="search-btn"]'
        items = super(GzGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GzGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
