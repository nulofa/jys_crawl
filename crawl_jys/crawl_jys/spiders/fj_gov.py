...
class FjGovSpider(scrapy.Spider, BaseCrawl):
    name = 'fj_gov'
    ...
    def parse(self, response):
        ...
        items = super(FjGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(FjGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
