...
class ScGovSpider(scrapy.Spider, BaseCrawl):
    ...
    def parse(self, response):
        ...
        search_xpath = "//img[@onclick='SearchUs()']"
        items = super(ScGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(ScGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
