...
class ShGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'sh_gzw'
    ...
    def parse(self, response):
        ...
        items = super(ShGzwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        url_xp = "./a"
        next_xp = ""
        super(ShGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
