...
class ScGzwSpider(scrapy.Spider, BaseCrawl):
    name = 'sc_gzw'
    start_urls = ['http://gzw.sc.gov.cn/guestweb4/index/5100000052']
    ...
    def parse(self, response):
        ...
        items = super(ScGzwSpider, self).myParse(response, input_xpath, search_xpath,"//p[@class='fl']")
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(ScGzwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
