...
class HnJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'hn_jrj'
    start_urls = ['http://jrj.hainan.gov.cn']
    ...
    def parse(self, response):
        ...
        search_xpath = "//div[@class='hsele']"
        items = super(HnJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HnJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
