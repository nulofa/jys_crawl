...
class NmgJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'nmg_jrj'
    start_urls = ['http://jrj.nmg.gov.cn']
    # custom_settings = {
    #     'HEADLESS': False,
    #     'IMAGELESS': True
    # }
    ...
    def parse(self, response):
        ...
        items = super(NmgJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(NmgJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '内蒙古金融局'  # 需要修改为当前的网站名，如：广东发改委
