...
class TjJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'tj_jrj'
    start_urls = ['http://jrgz.tj.gov.cn']
    ...
    def parse(self, response):
        ...
        search_xpath = "//button[@onclick='jumpToSearch()']"
        items = super(TjJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(TjJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '天津金融局'  #需要修改为当前的网站名，如：广东发改委
