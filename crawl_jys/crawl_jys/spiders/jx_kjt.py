...
class JxKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'jx_kjt'
    start_urls = ['http://kjt.jiangxi.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(JxKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        next_xp = ""
        super(JxKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        timeStart.click()
        thred = datetime.date.today() - datetime.timedelta(JxKjtSpider.date_limit)
