...
class HljFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'hlj_fgw'
    start_urls = ['http://drc.hlj.gov.cn']
    # custom_settings = {
    #     'HEADLESS': False,
    #     'IMAGELESS': True
    # }
    ...
    def parse(self, response):
        input_xpath = '//*[@id="q"]'
        search_xpath = "//input[@class='input2']"
        items = super(HljFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(HljFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        try:
            ...
            self.get_element_by_xpath("//div[@class='retractopenTools clearfix']").click()
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '黑龙江发改委'  #需要修改为当前的网站名，如：广东发改委
