...
class NxJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'nx_jrj'
    ...
    def parse(self, response):
        ...
        search_xpath = '//*[@id="btn"]'
        items = super(NxJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(NxJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        self.get_element_by_xpath('//*[@id="buscroll"]/li[22]').click()  # select department
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '宁夏金融局'  # 需要修改为当前的网站名，如：广东发改委
