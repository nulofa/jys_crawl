...
class GxJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'gx_jrj'
    start_urls = ['http://dfjrjgj.gxzf.gov.cn']
    ...
    def parse(self, response):
        input_xpath = "//div[@class='site-search']//input[@name='searchWord']"
        search_xpath = "//div[@class='site-search']//input[@class='i-site site-search-submit']"
        items = super(GxJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GxJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
