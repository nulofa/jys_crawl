...
class GsGovSpider(scrapy.Spider, BaseCrawl):
    name = 'gs_gov'
    start_urls = ['http://www.gansu.gov.cn']
    timeout = 3
    # custom_settings = {
    #     'HEADLESS': False,
    #     'IMAGELESS': True
    ...
    def parse(self, response):
        input_xpath = '//*[@id="searchtext"]'
        search_xpath = '//*[@id="sosbtn"]'
        items = super(GsGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(GsGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '甘肃政府网'  #需要修改为当前的网站名，如：广东发改委
