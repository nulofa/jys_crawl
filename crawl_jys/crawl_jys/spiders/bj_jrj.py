...
class BjJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'bj_jrj'
    ...
    def parse(self, response):
        ...
        items = super(BjJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(BjJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        self.get_element_by_xpath('//*[@id="WEBSITENAME北京市地方金融监督管理局"]').click()
        time.sleep(1)
    ...
    def process_item(self, new, item, title_xp, url_xp):
        ...
        item['source'] = '北京金融局'  # 需要修改为当前的网站名，如：广东发改委
