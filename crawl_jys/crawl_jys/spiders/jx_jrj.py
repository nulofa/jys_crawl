...
class JxJrjSpider(scrapy.Spider, BaseCrawl):
    name = 'jx_jrj'
    start_urls = ['http://jxjr.jiangxi.gov.cn']
    ...
    def parse(self, response):
        ...
        items = super(JxJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        next_xp = ""
        super(JxJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
    ...
    def time_select(self):
        ...
        timeStart.click()
        thred = datetime.date.today() - datetime.timedelta(JxJrjSpider.date_limit)
