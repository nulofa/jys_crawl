...
class GdGovSpider(scrapy.Spider, BaseCrawl):
    name = 'gd_gov'
    ...
    def parse(self, response):
        ...
        items = super(GdGovSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        next_xp = ""
        super(GdGovSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
