...
class FjJrjSpider(scrapy.Spider, BaseCrawl):
    ...
    def parse(self, response):
        ...
        items = super(FjJrjSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(FjJrjSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
