...
class JxFgwSpider(scrapy.Spider, BaseCrawl):
    name = 'jx_fgw'
    ...
    def parse(self, response):
        ...
        items = super(JxFgwSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        next_xp = ""
        super(JxFgwSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
