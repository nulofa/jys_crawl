...
class FjKjtSpider(scrapy.Spider, BaseCrawl):
    name = 'fj_kjt'
    ...
    def parse(self, response):
        ...
        items = super(FjKjtSpider, self).myParse(response, input_xpath, search_xpath)
        for item in items:
            yield item
    ...
    def myGetData(self, keyword):
        ...
        super(FjKjtSpider, self).get_data(keyword, wait2_xp, wait3_xp, news_xp, date_xp, content_xp,
